...
//	PORT("port", "27017", "Port", true, null),
	...
	AUTH_SOURCE("authSource", null, "authSource=string: The source of the authentication credentials. This is typically the database that the credentials have been created. The value defaults to the database specified in the path portion of the URI. If the database is specified in neither place, the default value is \"admin\". This option is only respected when using the MONGO-CR mechanism (the default).", false, null),
